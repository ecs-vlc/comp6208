...
\maketitle
\section{Keywords}
\label{sec:org3d322d3}
\begin{itemize}
\item Gaussian Processes, regression
\end{itemize}
\section{Main Points}
\label{sec:org27ec4ff}

\subsection{The Big Picture}
\label{sec:orge8c8754}
\begin{itemize}
...
\end{itemize}
\section{Exercises}
\label{sec:org480759c}

\subsection{Working with Gaussians}
\label{sec:org786fd7a}
...
\end{verbatim}
\section{Answers}
\label{sec:orgda3b0e5}
\subsection{Working with Gaussians}
\label{sec:orgd78b66d}
\begin{enumerate}
